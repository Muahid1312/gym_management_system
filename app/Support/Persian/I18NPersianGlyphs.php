 ...
 * ----------------------------------------------------------------------
 *
 * Class Name: Persian Glyphs is a simple class to render Persian text
 *
 * Filename:   Glyphs.php
 *
 * Original    Author(s): Khaled Al-Sham'aa <khaled@ar-php.org>, Mahmood Namvar <phpnukiha@yahoo.com>
 *
 ...
 * ----------------------------------------------------------------------
 *
 * Persian Glyphs is class to render Persian text
 *
 ...
 * Example:
 * <code>
 *   include('./I18N/Persian.php');
 *   $obj = new I18N_Persian('Glyphs');
 *
...
// namespace I18N\Persian;
//
// $obj = new I18N\Persian\Glyphs();
//
// use I18N\Persian;
// $obj = new Persian\Glyphs();
//
// use I18N\Persian\Glyphs as Glyphs;
// $obj = new Glyphs();

/**
 * This PHP class render Persian text by performs Persian glyph joining on it
 *
 * @category  I18N
...
class I18NPersianGlyphs
{
    ...
    public function __construct()
    {
        ...
        $this->_hex    .= 'FB93FB94FB95FB8EFB8FFB90FB91FBFCFBFDFBFEFBFF';
        //

        $this->_prevLink .= "پچژگکی";
        $this->_nextLink .= "پچژگکی";
        //
    ...
    /**
     * Calculate the lines number of given Persian text and font size that will
     * fit in A4 page size
     *
    ...
    protected function decodeEntities($text, $exclude = array())
    {
        ...
        if (!isset($table)) {
            $table = array_flip(get_html_translation_table(HTML_ENTITIES, ENT_QUOTES | ENT_HTML5, 'UTF-8'));
    ...
    protected function decodeEntities2(
        ...
        if ($prefix == '#x') {
            $codepoint = (int)base_convert($codepoint, 16, 10);
        } else {
