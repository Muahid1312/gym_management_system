...
@section('title', 'Generate Workout & Diet Plans')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="lg:col-span-2">
        <x-card class="bg-slate-950 border-slate-700">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-white">Memeber info</h2>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div class="bg-slate-900 rounded-lg p-4">
                    ...
                    <p class="text-white font-semibold">{{ $member->phone ?? 'Unkonwn' }}</p>
                </div>
                <div class="bg-slate-900 rounded-lg p-4">
                    <p class="text-gray-500 text-sm">Date of membership</p>
                    <p class="text-white font-semibold">{{ $member->join_date?->format('M d, Y') ?? 'Unkown' }}</p>
                </div>
            </div>
        </x-card>
    </div>
    ...
    <div>
        <x-card class="bg-slate-950 border-slate-700 h-full">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-white">Generate Workout Plan</h2>
                @if ($latestWorkout)
            ...
            <form action="{{ route('ai.workout', $member) }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="workout_age" class="block text-gray-400 font-semibold mb-2">Age</label>
                ...
                <div>
                    <label for="workout_weight" class="block text-gray-400 font-semibold mb-2">Weight(kg)</label>
                ...
                <div>
                    <label for="workout_height" class="block text-gray-400 font-semibold mb-2">height(cm)</label>
                ...
                <div>
                    <label for="workout_goal" class="block text-gray-400 font-semibold mb-2">Goal</label>
                ...
                <div>
                    <label for="workout_level" class="block text-gray-400 font-semibold mb-2">Level Experiance</label>
                    <select id="workout_level" name="level" required
                        class="w-full rounded-lg border border-slate-700 bg-slate-900 px-4 py-2 text-white outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
                        <option value="">Choose your level experiance</option>
    ...
    <div>
        <x-card class="bg-slate-950 border-slate-700 h-full">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-white">Generat Diet Plan</h2>
                @if ($latestDiet)
                    <span class="px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-xs font-semibold">ایجاد شده</span>
                @endif
            </div>
            ...
            <form action="{{ route('ai.diet', $member) }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="diet_age" class="block text-gray-400 font-semibold mb-2">Age</label>
                ...
                <div>
                    <label for="diet_weight" class="block text-gray-400 font-semibold mb-2">Weight(kg)</label>
                ...
                <div>
                    <label for="diet_height" class="block text-gray-400 font-semibold mb-2">Height(cm)</label>
                ...
                <div>
                    <label for="diet_goal" class="block text-gray-400 font-semibold mb-2">Goal</label>
                ...
                <div>
                    <label for="diet_level" class="block text-gray-400 font-semibold mb-2">Level Experiance</label>
