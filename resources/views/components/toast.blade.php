...
@php
    ...
    $classes = 'toast fixed top-4 right-4 z-50 p-4 rounded-md shadow-lg transform translate-x-full transition-transform duration-300 ' . ($typeClasses[$type] ?? $typeClasses['info']);
@endphp

<div {{ $attributes->merge(['class' => $classes, 'data-duration' => $duration]) }}>
